...
export default function ProductionEnvironmentNotApprovedDetails(props: any) {
                    ...
                    <Grid item>
                        <Box paddingBottom={1}>
                            <Typography variant="h4">
                                Production Environment Details (Hidden Not Approved)
                            </Typography>
                        </Box>
                    </Grid>
                    {/*<Grid item>*/}
                                    ...
                                    <Box m={3}  >
                                        <div id="activate-description">
                                            ...
                                            <Link to='activate-account'>
                                                <button className='activate'>Activate production account</button>
                                            </Link>
                                        </div>
                                    </Box>
                                </Grid>
